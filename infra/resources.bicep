...
// Service Connector from the app to the key vault, which generates the connection settings for the Spring Boot application
...
// Service Connector from the app to the database, which generates the connection settings for the Spring Boot application
resource dbConnector 'Microsoft.ServiceLinker/linkers@2024-04-01' = {
  scope: web
  name: 'springConnector'
  properties: {
    clientType: 'springBoot'
    targetService: {
      type: 'AzureResource'
...
// Service Connector from the app to the cache, which generates the connection settings for the Spring Boot application
